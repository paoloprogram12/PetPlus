// ============================================================
// AddPetScreen.jsx — The "Add Pet" form screen.
//
...
export default function AddPetScreen() {
  ...
  const [name, setName] = useState(editPet?.name ?? ""); // Pet name — starts empty
  const [type, setType] = useState(editPet?.type ?? "Dog"); // Pet type — defaults to "Dog"
  const [age, setAge] = useState(editPet ? String(editPet.age) : "1"); // Age as a STRING because TextInput works with strings
