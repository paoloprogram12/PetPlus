// ============================================================
// LogCareScreen.jsx — The "Log Care" screen.
//
...
export default function LogCareScreen() {
  ...
  // Which pet is currently selected. Can be a pet's ID string,
  // or null if no pet is selected yet.
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={styles.content}>
      ...
      {/* Three chip buttons with icons: Feeding, Walk, Medication.
          These come from the CARE_TYPES constant in PetStore.js */}
